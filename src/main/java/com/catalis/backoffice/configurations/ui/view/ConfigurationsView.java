...
public class ConfigurationsView extends VerticalLayout implements HasUrlParameter<String> {
    ...
    public void setParameter(BeforeEvent event, @OptionalParameter String parameter) {
        if (tabs != null) {
            int selectedTab = 0;
            if ("master-data".equals(parameter)) {
                selectedTab = 0;
            } else if ("platform-config".equals(parameter)) {
                selectedTab = 1;
            } else if ("users".equals(parameter)) {
                selectedTab = 2;
            } else if ("products".equals(parameter)) {
                selectedTab = 3;
            }
    ...
    public ConfigurationsView() {
        ...
        this.tabs = new Tabs(masterDataTab, platformConfigTab, usersTab, productsTab);
