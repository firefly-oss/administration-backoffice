...
public class EditAccount extends Dialog {
    ...
    private ComboBox<CreateAccount.AccountType> accountTypeField;
    private TextField currencyField;
    private NumberField balanceField;
    private ComboBox<CreateAccount.AccountStatus> statusField;
    private TextField customerIdField;
    private TextField descriptionField;
    private TextField contractIdField;
    private TextField branchIdField;
    private ComboBox<CreateAccount.AccountSubType> accountSubTypeField;
    private ComboBox<CreateAccount.TaxReportingStatus> taxReportingStatusField;
    private ComboBox<CreateAccount.RegulatoryStatus> regulatoryStatusField;
     ...
     */
    public EditAccount(AccountsService accountsService, AccountDTO account, Runnable onSuccess) {
    ...
    private FormLayout createForm() {
        ...
        accountTypeField.setItems(Arrays.asList(CreateAccount.AccountType.values()));
        ...
        binder.forField(accountTypeField)
                ...
                .withConverter(
                        CreateAccount.AccountType::getValue,
                        value -> Arrays.stream(CreateAccount.AccountType.values())
        ...
        statusField.setItems(Arrays.asList(CreateAccount.AccountStatus.values()));
        statusField.setRequired(true);
        statusField.setAllowCustomValue(false);
        binder.forField(statusField)
                .asRequired("Status is required")
                .withConverter(
                        CreateAccount.AccountStatus::getValue,
                        value -> Arrays.stream(CreateAccount.AccountStatus.values())
        ...
        accountSubTypeField.setItems(Arrays.asList(CreateAccount.AccountSubType.values()));
        accountSubTypeField.setAllowCustomValue(false);
        binder.forField(accountSubTypeField)
                .withConverter(
                        CreateAccount.AccountSubType::getValue,
                        value -> Arrays.stream(CreateAccount.AccountSubType.values())
                                .filter(type -> type.getValue().equals(value))
                                .findFirst()
                                .orElse(null),
        ...
        taxReportingStatusField.setItems(Arrays.asList(CreateAccount.TaxReportingStatus.values()));
        taxReportingStatusField.setAllowCustomValue(false);
        binder.forField(taxReportingStatusField)
                .withConverter(
                        CreateAccount.TaxReportingStatus::getValue,
                        value -> Arrays.stream(CreateAccount.TaxReportingStatus.values())
                                .filter(status -> status.getValue().equals(value))
                                .findFirst()
                                .orElse(null),
        ...
        regulatoryStatusField.setItems(Arrays.asList(CreateAccount.RegulatoryStatus.values()));
        regulatoryStatusField.setAllowCustomValue(false);
        binder.forField(regulatoryStatusField)
                .withConverter(
                        CreateAccount.RegulatoryStatus::getValue,
                        value -> Arrays.stream(CreateAccount.RegulatoryStatus.values())
                                .filter(status -> status.getValue().equals(value))
                                .findFirst()
                                .orElse(null),
